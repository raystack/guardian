...
func (_m *Repository) Find(_a0 context.Context, _a1 domain.ProviderFilter) ([]*domain.Provider, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *Repository_Find_Call) Run(run func(_a0 context.Context, _a1 domain.ProviderFilter)) *Repository_Find_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.ProviderFilter))
	})
	return _c
}
...
func (_c *Repository_Find_Call) RunAndReturn(run func(context.Context, domain.ProviderFilter) ([]*domain.Provider, error)) *Repository_Find_Call {
	_c.Call.Return(run)
	return _c
}
