...
func (_m *Repository) Create(_a0 *domain.Policy) error {
	ret := _m.Called(_a0)
...
func (_m *Repository) Find() ([]*domain.Policy, error) {
	ret := _m.Called()
...
func (_m *Repository) GetOne(id string, version uint) (*domain.Policy, error) {
