...
func (s *ServiceTestSuite) TestListApprovals() {
	s.Run("should return error if got error from repository", func() {
		...
		s.mockRepository.EXPECT().
			ListApprovals(mock.AnythingOfType("context.backgroundCtx"), mock.Anything).
...
func (s *ServiceTestSuite) TestGetApprovalsTotalCount() {
	s.Run("should return error if got error from repository", func() {
		expectedError := errors.New("repository error")
		s.mockRepository.EXPECT().
			GetApprovalsTotalCount(mock.AnythingOfType("context.backgroundCtx"), mock.Anything).
...
func (s *ServiceTestSuite) TestBulkInsert() {
	s.Run("should return error if got error from repository", func() {
		expectedError := errors.New("repository error")
		s.mockRepository.EXPECT().
			BulkInsert(mock.AnythingOfType("context.backgroundCtx"), mock.Anything).
...
func (s *ServiceTestSuite) TestAddApprover() {
	s.Run("should return nil error on success", func() {
		...
		s.mockRepository.EXPECT().AddApprover(mock.AnythingOfType("context.backgroundCtx"), expectedApprover).Return(nil)
	...
	s.Run("should return error if repository returns an error", func() {
		...
		s.mockRepository.EXPECT().AddApprover(mock.AnythingOfType("context.backgroundCtx"), mock.Anything).Return(expectedError)
...
func (s *ServiceTestSuite) TestDeleteApprover() {
	s.Run("should return nil error on success", func() {
		...
		s.mockRepository.EXPECT().DeleteApprover(mock.AnythingOfType("context.backgroundCtx"), approvalID, approverEmail).Return(nil)
	...
	s.Run("should return error if repository returns an error", func() {
		expectedError := errors.New("unexpected error")
		s.mockRepository.EXPECT().DeleteApprover(mock.AnythingOfType("context.backgroundCtx"), mock.Anything, mock.Anything).Return(expectedError)
