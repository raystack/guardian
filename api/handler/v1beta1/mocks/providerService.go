...
func (_c *ProviderService_Find_Call) Run(run func(_a0 context.Context, _a1 domain.ProviderFilter)) *ProviderService_Find_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProviderService_Find_Call) RunAndReturn(run func(context.Context, domain.ProviderFilter) ([]*domain.Provider, error)) *ProviderService_Find_Call {
	_c.Call.Return(run)
	return _c
}
