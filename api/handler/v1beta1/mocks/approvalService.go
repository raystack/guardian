...
func (_m *ApprovalService) UpdateApproval(ctx context.Context, approvalAction domain.ApprovalAction) (*domain.Appeal, error) {
...
func (_e *ApprovalService_Expecter) UpdateApproval(ctx interface{}, approvalAction interface{}) *ApprovalService_UpdateApproval_Call {
	return &ApprovalService_UpdateApproval_Call{Call: _e.mock.On("UpdateApproval", ctx, approvalAction)}
}

func (_c *ApprovalService_UpdateApproval_Call) Run(run func(ctx context.Context, approvalAction domain.ApprovalAction)) *ApprovalService_UpdateApproval_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ApprovalService_UpdateApproval_Call) Return(_a0 *domain.Appeal, _a1 error) *ApprovalService_UpdateApproval_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
