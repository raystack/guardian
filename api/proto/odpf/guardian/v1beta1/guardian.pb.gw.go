...
func request_GuardianService_UpdateApprovalViaSlack_0(ctx context.Context, marshaler runtime.Marshaler, client GuardianServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateApprovalViaSlackRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateApprovalViaSlack(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_GuardianService_UpdateApprovalViaSlack_0(ctx context.Context, marshaler runtime.Marshaler, server GuardianServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateApprovalViaSlackRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateApprovalViaSlack(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterGuardianServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GuardianServiceServer) error {
	...
	mux.Handle("POST", pattern_GuardianService_UpdateApprovalViaSlack_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/odpf.guardian.v1beta1.GuardianService/UpdateApprovalViaSlack", runtime.WithHTTPPathPattern("/v1beta1/appeals/slack"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_GuardianService_UpdateApprovalViaSlack_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_GuardianService_UpdateApprovalViaSlack_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGuardianServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GuardianServiceClient) error {
	...
	mux.Handle("POST", pattern_GuardianService_UpdateApprovalViaSlack_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/odpf.guardian.v1beta1.GuardianService/UpdateApprovalViaSlack", runtime.WithHTTPPathPattern("/v1beta1/appeals/slack"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_GuardianService_UpdateApprovalViaSlack_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_GuardianService_UpdateApprovalViaSlack_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1beta1", "appeals", "slack"}, ""))
...
var (
	...
	forward_GuardianService_UpdateApprovalViaSlack_0 = runtime.ForwardResponseMessage
