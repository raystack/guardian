...
func (_m *ResourceRepository) Delete(id string) error {
	ret := _m.Called(id)
...
func (_m *ResourceRepository) GetOne(id string) (*domain.Resource, error) {
	ret := _m.Called(id)
...
func (_m *ResourceRepository) Update(_a0 *domain.Resource) error {
	ret := _m.Called(_a0)
